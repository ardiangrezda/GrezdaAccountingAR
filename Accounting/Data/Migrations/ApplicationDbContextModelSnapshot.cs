...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accounting.Models.BusinessUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Accounting.Models.InvoiceNumberFormat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Accounting.Models.SalesInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Accounting.Models.SalesInvoiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Accounting.Models.Subject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Accounting.Models.Submodule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Accounting.Models.UserBusinessUnit", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Accounting.Models.UserModuleAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Accounting.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Accounting.Models.InvoiceNumberFormat", b =>
                {
                    ...
                    b.HasOne("Accounting.Models.SalesCategory", "SalesCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Accounting.Models.SalesInvoice", b =>
                {
                    ...
                    b.HasOne("Accounting.Models.Subject", "Buyer")
                        .WithMany()
                    ...
                    b.HasOne("Accounting.Models.SalesInvoice", "OriginalInvoice")
                        .WithMany("Returns")
            ...
            modelBuilder.Entity("Accounting.Models.SalesInvoiceItem", b =>
                {
                    ...
                    b.HasOne("Accounting.Models.SalesInvoiceItem", "OriginalInvoiceItem")
                        .WithMany("ReturnItems")
                        .HasForeignKey("OriginalInvoiceItemId");

                    b.HasOne("Accounting.Models.SalesInvoice", "SalesInvoice")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Accounting.Models.Submodule", b =>
                {
                    b.HasOne("Accounting.Models.Module", "Module")
                        .WithMany("Submodules")
            ...
            modelBuilder.Entity("Accounting.Models.UserBusinessUnit", b =>
                {
                    ...
                    b.HasOne("Accounting.Models.ApplicationUser", "User")
                        .WithMany("UserBusinessUnits")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Accounting.Models.UserModuleAccess", b =>
                {
                    ...
                    b.HasOne("Accounting.Models.Submodule", "Submodule")
                        .WithMany()
